...
var ClickSlider = {
    create : function (slider, text, range) {
        ...
        slider.noUiSlider.on("set", this.on_set_slider_val(slider, text));
        slider.noUiSlider.on("slide", this.update_slider_text_val(text));
        ...
        for ( var i = 0; i < pips.length; i++ ) {
            ...
            pips[i].addEventListener('click', this.click_on_pip(slider));
        }
    },

    click_on_pip : function (slider) {
    ...
    on_set_slider_val : function (slider, text){
        ...
        var _update_slider_text_val = this.update_slider_text_val(text);
    ...
    update_slider_text_val : function (text){
